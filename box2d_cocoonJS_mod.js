...
if ( !window.ext || typeof window.ext.IDTK_SRV_BOX2D === 'undefined' ){
    ...
    (function (){
        ...
        B2Transform.prototype.Initialize = function (pos, r) {
            console.log(this.position, this.R);
            this.position.SetV(pos);
            this.R.SetM(r);
        };
    ...
    // ***************************************************************************
        ...
        B2World.prototype.CreateJoint = function (def) {
            ...
            console.log('def', this.m_worldID, def);
    
            window.ext.IDTK_SRV_BOX2D.makeCall( "createPrismaticJoint" , this.m_worldID , def ) ;
        ...
        var B2PrismaticJointDef = function( bA , bB , anchorA , anchorB ) {
            console.log('kurt');
        ...
        window.Box2D.Dynamics.Joints.b2PrismaticJointDef = B2PrismaticJointDef ;
